...
import RechartPieOriginal from "../Charts/RechartPieOriginal";
    ...
    {Loader ? (
       ...
       <div className="eventInfo__budget">
        <div className="chartContainer">
          ...
          <div className="perPersonDetail" style={{display:'flex',justifyContent:"center",alignItems:"center"}}>
            <div className="eventInfo__budget__details" style={{marginRight:"20px"}}>
              <p>Total Budget</p>
              <h3>$12000</h3>
              <br />
